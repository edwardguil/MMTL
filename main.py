...
from dataloader import ElarDataset, elar_collate_fn
...
def main():
    ...
    # Prepare Data Sample
    dataset = ElarDataset('data_sentences.json', 'classes.json', 'lexicon.txt', './ELAR_data', mean=[0.2481, 0.2395, 0.3078], std=[0.2542, 0.2231, 0.2403])
